...
1) Open <http://localhost:8000> in your browser. The server injects `window.__firebase_config` and `window.__app_id` so the app boots without editing `index.html`.
